...
function App() {
    return (jsxRuntime.exports.jsx("div", __assign({ className: "App" }, { children: jsxRuntime.exports.jsxs("header", __assign({ className: "App-header" }, { children: [jsxRuntime.exports.jsxs("p", { children: ["Edit ", jsxRuntime.exports.jsx("code", { children: "src/App.tsx" }), " and save to reload."] }), jsxRuntime.exports.jsx("a", __assign({ className: "App-link", href: "https://reactjs.org", target: "_blank", rel: "noopener noreferrer" }, { children: "Learn React" }))] })) })));
}

var reportWebVitals = function (onPerfEntry) {
    if (onPerfEntry && onPerfEntry instanceof Function) {
        Promise.resolve().then(function () { return require('./web-vitals-132e5b04.js'); }).then(function (_a) {
...
ReactDOM.render(jsxRuntime.exports.jsx(React.StrictMode, { children: jsxRuntime.exports.jsx(App, {}) }), document.getElementById('root'));

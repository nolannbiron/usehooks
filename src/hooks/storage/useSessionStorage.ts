...
function useSessionStorage<T>(key: string, initialValue?: T): [T | undefined, SetValue<T>, any] {
    ...
    const setValue: SetValue<T> = useCallback(
        value => {
          ...
          try {
            const newValue = value instanceof Function ? value(storedValue ?? undefined) : value

...
const useTimeSince = (date: Date | string, asString?: boolean, format?: TimeSinceFormatOptions): ReturnTypes => {
...
function timeDifference<T extends ReturnTypes>(date: Date, format: TimeSinceFormatOptions, returnType: T): ReturnTypes {
